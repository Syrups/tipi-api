...
ActiveRecord::Schema.define(version: 20150524112102) do
  ...
  create_table "api_presences", force: :cascade do |t|
    t.boolean  "active",     default: false
    t.integer  "room_id"
    t.integer  "user_id"
    t.datetime "created_at",                 null: false
  ...
  create_table "api_user_devices", force: :cascade do |t|
    t.string   "token"
    t.integer  "user_id"
    t.string   "platform"
    t.datetime "created_at", null: false
